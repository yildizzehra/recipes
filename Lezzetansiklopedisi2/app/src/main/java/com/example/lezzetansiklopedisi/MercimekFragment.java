...
public class MercimekFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mercimek, container, false);
    ...
    public void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            try {
                ...
                ex.printStackTrace(); // Hata hakkında daha fazla bilgi edinmek için
            }
            if (photoFile != null) {
    ...
    private File createImageFile() throws IOException {
        ...
        String imageFileName = "ReceivedPhoto";
